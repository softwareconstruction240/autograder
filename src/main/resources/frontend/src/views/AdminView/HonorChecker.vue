...
<template>
  <div class="container">
    ...
    <p class="desc">
      If you are a professor who wants to run the honor checker on your section, you've come to the
      right place! The honor checker itself is located elsewhere, but below, you can download .zip
      files of your section(s). Each section .zip file contains a .zip file for every student
    ...
    <select id="section" name="section" @change="onSelectionChange">
      <option v-for="section of sections" :key="section.name" :value="section.id">
        {{ section.name }}
      </option>
    </select>
