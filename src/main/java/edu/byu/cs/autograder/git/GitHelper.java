...
public class GitHelper {
    ...
    // TODO: Store in a more configurable place.
    // This didn't seem appropriate to add to GradingContext, but it would do well in a CourseConfig table
    /**
     * The number of minutes in the future we will tolerate local clock non-synchronization.
     * <br>
     ...
     */
    private static final long FORGIVENESS_MINUTES_HEAD = 3;
    ...
    private CommitThreshold constructCurrentThreshold(Git git) throws IOException, GradingException, DataAccessException {
        ...
        if (handInTimestamp != null) {
            handInTimestamp = handInTimestamp.plusSeconds(FORGIVENESS_MINUTES_HEAD * 60);
        }
