...
//        minThreshold = new CommitThreshold(Instant.MIN, "6ec3b15af512f42cfad177388b6422b60309cc5e");
     ...
     * <br>
     * The logic currently occurs in {@link GradingHelper#constructCurrentThreshold(Git)} which is bypassed when we directly
     * call {@link GradingHelper#verifyRegularCommits(Git, CommitThreshold, CommitThreshold)}.
     * Normal calls to {@link GradingHelper#verifyCommitRequirements(File)} will evaluate the rules.
     * <br>
     ...
     * <br>
     * Instead, we independently implemented the (simple) logic in {@link GitHelperUtils#evaluateRepo(GradingHelper, CommitThreshold)}
